...
class DoclingService:
    ...
    def chunk_with_hybrid(self, doc, max_tokens: int = 512, min_tokens: int = 256) -> List[DocumentChunk]:
        """
    ...
    def parse_and_chunk_document(self, file_path: str, chunk_size: int = 512, min_chunk_size: int = 256) -> List[DocumentChunk]:
        """
        ...
        try:
            ...
            chunks = self.chunk_with_hybrid(doc, max_tokens=chunk_size, min_tokens=min_chunk_size)
